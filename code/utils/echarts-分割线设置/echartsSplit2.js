...
const echartsSplit = (
  ...
  let maxValue = Math.ceil(Math.max(...valueArr))
  let minValue = Math.floor(Math.min(...valueArr))
  ...
  // let splitResult = Number(splitValue.toFixed(2));
  // 如果所有数据值都一样的特殊情况处理
  if (splitResult == 0) {
