...
import { getRateMap, getEvaluativeDimension } from "@/views/panels/construction-management/mock/mock";
...
export default {
  ...
  methods: {
    ...
    async getData() {
      const data = await getEvaluativeDimension('safety');
      getRateMap().then((map) => {
